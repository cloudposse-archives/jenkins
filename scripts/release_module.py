...
parser.add_argument('--artifact_id', help='The new artifact ids we are deploying (generated by Jenkins)')
...
def copy_release_file(module, source_env, target_env, artifact_id):
    ...
    data["sha"] = artifact_id
    create_release_file(target_env, module, artifact_id)
...
copy_release_file(MODULE, SOURCE_ENV, TARGET_ENV, ARTIFACT_ID)
